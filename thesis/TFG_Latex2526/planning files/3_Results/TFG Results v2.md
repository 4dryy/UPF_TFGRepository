...
The usability evaluation of the Coronary Explorer Dashboard was conducted using the standard System Usability Scale (SUS). The system achieved an overall mean score of **70.83 out of 100**, with a standard deviation of 15.07. This value sits comfortably above the widely accepted threshold for average usability (68.0), confirming the practical viability and structural coherence of the interface in a clinical setting.

Analyzing the individual metrics, the results demonstrate strong acceptance of the proposed tool. Notably, 100% of the participants rated their intention to use this coronary visualization tool frequently in clinical practice highly (scoring 4 or 5 out of 5). Furthermore, 66.6% of the evaluators found the system easy to use and intuitive, noting with the same percentage that the various functionalities and visual components (3D meshes, profile charts, and clinical metrics) were well integrated into a cohesive interface.

Regarding the system's adoption by specialists, 66.6% of the participants believed that most medical professionals would learn to use this tool very quickly. Importantly, none of the respondents categorized the platform as "unnecessarily complex." However, a degree of clinical caution was captured regarding diagnostic confidence: only one-third (33.3%) stated they felt confident making CAD-RADS estimations relying solely on the system, while the remaining majority adopted a neutral stance (score of 3). This effectively validates the core design philosophy of the system: it operates as a decision-support tool meant to streamline triage and assist the clinician, rather than a definitive diagnostic replacement seeking to bypass final expert validation.
