...
\noindent
Coronary Artery Disease (CAD), Coronary Computed Tomography Angiography (CCTA), Coronary Artery Disease Reporting And Data System (CAD-RADS), Stenosis Quantification, Percentage Area Stenosis, Vascular Centerlines, Three-Dimensional Visualization, Clinical Decision Support, Automated Reporting, Patient Prioritization.
