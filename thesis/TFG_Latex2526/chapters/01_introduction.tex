...
Figure~\ref{fig:proposed-workflow} provides a high-level overview of where this project sits within the pipeline, while the detailed technical workflow is reserved for the Methodology chapter.
